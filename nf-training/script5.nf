...
/*
* Nextflow DSL2 knows to split the reads_pair_ch into two identical channels as
* they are required twice as an input for both of the FASTQC and the QUANTIFICATION process.
*/
